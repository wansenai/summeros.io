  ...
  return (
    <div className="home">
            ...
            <div className="card-box">
              <div className="line">
                <div className="card flex align-center">
                  <img
                    src={getHomeSrc('trophy-removebg-preview 1@2x.png')}
                    alt=""
                  />
                  <div>
                    <p>Best Open</p>
      ...
      <div className="home-content">
        <Button className="button-green start-btn" size="large" type="primary">
          Quick Start
        </Button>
      </div>
      <div className="doc-area flex space-between">
        ...
        <Button className="button-green" size="large" type="primary">
          Read Document
        </Button>
      </div>
      <div className="to-do">
      ...
      <div className="email-box">
        <div className="email">
          ...
          <div className="input-box">
            ...
            <Button className="email-btn" size="large" type="primary">
              Subscribe
            </Button>
          </div>
        </div>
